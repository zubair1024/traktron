...
module.exports = {
  ...
  devServer: {
    ...
    proxy : {
      /*
       * Proxy API requests to our external backend development server.
       * Pick (or add) your favorite one.
       */
      '/service/*': {
        target: 'http://latest.roamworks.com/actiondemo',

        //target: 'http://latest.roamworks.com/roamdailybuild',
        //target: 'http://latest.roamworks.com/engineersoffice',
        //target: 'http://latest.roamworks.com/dewa',
        //target: 'http://rstg.cap-cwm.com/prerel',
        secure: false,
      },
    },
  },
